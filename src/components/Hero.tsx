...
const Hero = () => {
  const socialLinks = [
    ...
    { icon: <Mail className="h-5 w-5" />, href: 'mailto:muhammed@example.com', label: 'Email' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <div className="w-32 h-32 mx-auto mb-8 relative">
            <div className="w-full h-full bg-gradient-to-r from-blue-400 to-purple-500 rounded-full p-1">
              <div className="w-full h-full bg-slate-800 rounded-full flex items-center justify-center">
                <span className="text-4xl font-bold text-gradient">MH</span>
              </div>
            </div>
